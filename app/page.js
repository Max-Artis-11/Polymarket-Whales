      ...
      <div style={S.filterBar}>
        <div style={S.fieldGroup}>
          ...
          <div style={S.row}>
            <input
              ...
              onChange={(e) => setFilters((f) => ({ ...f, minProb: parseInt(e.target.value) || 1 }))}
            ...
            <input
              ...
              onChange={(e) => setFilters((f) => ({ ...f, maxProb: parseInt(e.target.value) || 99 }))}
              onFocus={(e) => e.target.select()}
              style={S.input}
            />
          </div>
        ...
        <div style={S.fieldGroup}>
          ...
          <input
            ...
            onChange={(e) => setFilters((f) => ({ ...f, minWallets: parseInt(e.target.value) || 1 }))}
            onFocus={(e) => e.target.select()}
        ...
        <div style={S.fieldGroup}>
          ...
          <input
            type="number" min={0} max={500} value={filters.leaderboardLimit}
            onChange={(e) => setFilters((f) => ({ ...f, leaderboardLimit: parseInt(e.target.value) || 0 }))}
            onFocus={(e) => e.target.select()}
